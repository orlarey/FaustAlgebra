 ...
 * Nodes are fully described by the node.h file, there is no node.cpp file.
 *
 * <b>API:</b>
 *
...
inline Node addNode(const Node& x, const Node& y)
{
    return (isDouble(x) || isDouble(y)) ? Node(double(x) + double(y)) : Node(int(x) + int(y));
}

inline Node subNode(const Node& x, const Node& y)
{
    return (isDouble(x) || isDouble(y)) ? Node(double(x) - double(y)) : Node(int(x) - int(y));
}

inline Node mulNode(const Node& x, const Node& y)
{
    return (isDouble(x) || isDouble(y)) ? Node(double(x) * double(y)) : Node(int(x) * int(y));
}

inline Node divExtendedNode(const Node& x, const Node& y)
{
...
inline Node remNode(const Node& x, const Node& y)
{
    if (int(y) == 0) {
        std::stringstream error;
...
inline Node minusNode(const Node& x)
{
    return subNode(0, x);
}

inline Node inverseNode(const Node& x)
{
...
inline Node lshNode(const Node& x, const Node& y)
{
    return Node(int(x) << int(y));
}

inline Node arshNode(const Node& x, const Node& y)
{
    return Node(int(x) >> int(y));
}

inline Node lrshNode(const Node& x, const Node& y)
{
    return Node(int(x) >> int(y));
}
...
inline Node andNode(const Node& x, const Node& y)
{
    return Node(int(x) & int(y));
}

inline Node orNode(const Node& x, const Node& y)
{
    return Node(int(x) | int(y));
}

inline Node xorNode(const Node& x, const Node& y)
{
    return Node(int(x) ^ int(y));
}
...
inline Node gtNode(const Node& x, const Node& y)
{
    return (isDouble(x) || isDouble(y)) ? Node(double(x) > double(y)) : Node(int(x) > int(y));
}

inline Node ltNode(const Node& x, const Node& y)
{
    return (isDouble(x) || isDouble(y)) ? Node(double(x) < double(y)) : Node(int(x) < int(y));
}

inline Node geNode(const Node& x, const Node& y)
{
    return (isDouble(x) || isDouble(y)) ? Node(double(x) >= double(y)) : Node(int(x) >= int(y));
}

inline Node leNode(const Node& x, const Node& y)
{
    return (isDouble(x) || isDouble(y)) ? Node(double(x) <= double(y)) : Node(int(x) <= int(y));
}
#if 1
inline Node eqNode(const Node& x, const Node& y)
{
    return (isDouble(x) || isDouble(y)) ? Node(double(x) == double(y)) : Node(int(x) == int(y));
}

inline Node neNode(const Node& x, const Node& y)
{
    return (isDouble(x) || isDouble(y)) ? Node(double(x) != double(y)) : Node(int(x) != int(y));
}
#endif
