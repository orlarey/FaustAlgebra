...
const Sym DEBRUIJN    = symbol("DEBRUIJN");
const Sym DEBRUIJNREF = symbol("DEBRUIJNREF");
const Sym SUBSTITUTE  = symbol("SUBSTITUTE");
const Sym SYMREC      = symbol("SYMREC");
const Sym CONS        = symbol("cons");
const Sym NIL         = symbol("nil");
const Sym SYMLIFTN    = symbol("LIFTN");

// definitions
const Tree RECDEF       = tree(symbol("RECDEF"));
const Tree DEBRUIJN2SYM = tree(symbol("DEBRUIJN2SYM"));
const Tree nil          = tree(NIL);
